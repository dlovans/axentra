      ...
      {#if footerVisible}
        <div class="grid grid-cols-1 md:grid-cols-3 gap-10">
          ...
          <div in:sexyReveal={{ delay: 100, duration: 800, index: 0, direction: 'up' }}>
            <div class="flex items-center mb-6">
              ...
              <div class="text-xl font-bold text-violet-400" in:gradientTextReveal={{ delay: 300, duration: 1000 }}>Axentra AB</div>
            </div>
        ...
        <div class="border-t border-gray-800 mt-10 pt-6 flex flex-col md:flex-row justify-between items-center">
          ...
          <div class="flex space-x-4" in:sexyReveal={{ delay: 900, duration: 800, index: 1, direction: 'up' }}>
            <a href="https://www.linkedin.com/company/axentra-ab" class="text-gray-400 hover:text-violet-400 transition-colors transform hover:scale-110 duration-300" target="_blank" rel="noopener noreferrer">
      ...
      {:else}
        ...
        <div class="border-t border-gray-800 mt-10 pt-6 flex flex-col md:flex-row justify-between items-center opacity-0">
          ...
          <div class="flex space-x-4">
            <a href="https://www.linkedin.com/company/axentra-ab" target="_blank" rel="noopener noreferrer">
              <span class="sr-only">LinkedIn</span>
