    ...
    <div class="bg-amber-50 border border-amber-200 rounded-lg p-4 mb-6">
      <div class="flex items-start">
        ...
        <p class="text-sm text-gray-700">
          <span class="font-medium text-amber-700">Note:</span> Larger changes and development work exceeding 5 hours per month may require a separate quote. Contact me for more information.
        </p>
      </div>
    </div>
    ...
    <div class="flex flex-col sm:flex-row gap-4 items-center justify-between">
      <div>
        <div class="flex items-center mb-1">
          <span class="text-2xl font-bold text-gray-800 mr-2">Contact me</span>
